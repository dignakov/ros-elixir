defmodule Elixir.Tf2Msgs.LookupTransformActionFeedback do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          feedback: Elixir.Tf2Msgs.LookupTransformFeedback.t()
        }

  defstruct header: %Elixir.StdMsgs.Header{},
            status: %Elixir.ActionlibMsgs.GoalStatus{},
            feedback: %Elixir.Tf2Msgs.LookupTransformFeedback{}
