defmodule Elixir.Actionlib.TwoIntsActionResult do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          result: Elixir.Actionlib.TwoIntsResult.t()
        }

  defstruct header: %Elixir.StdMsgs.Header{},
            status: %Elixir.ActionlibMsgs.GoalStatus{},
            result: %Elixir.Actionlib.TwoIntsResult{}

  @impl ROS.Message.Behaviour
  def md5sum, do: "3ba7dea8b8cddcae4528ade4ef74b6e7"
