defmodule Elixir.Actionlib.TestActionGoal do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          goal: Elixir.Actionlib.TestGoal.t()
        }

  defstruct header: %Elixir.StdMsgs.Header{},
            goal_id: %Elixir.ActionlibMsgs.GoalID{},
            goal: %Elixir.Actionlib.TestGoal{}

  @impl ROS.Message.Behaviour
  def md5sum, do: "348369c5b403676156094e8c159720bf"
