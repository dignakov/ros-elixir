defmodule Elixir.Actionlib.TestActionResult do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          result: Elixir.Actionlib.TestResult.t()
        }

  defstruct header: %Elixir.StdMsgs.Header{},
            status: %Elixir.ActionlibMsgs.GoalStatus{},
            result: %Elixir.Actionlib.TestResult{}

  @impl ROS.Message.Behaviour
  def md5sum, do: "3d669e3a63aa986c667ea7b0f46ce85e"
