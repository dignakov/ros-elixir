defmodule Elixir.Actionlib.TestActionFeedback do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          feedback: Elixir.Actionlib.TestFeedback.t()
        }

  defstruct header: %Elixir.StdMsgs.Header{},
            status: %Elixir.ActionlibMsgs.GoalStatus{},
            feedback: %Elixir.Actionlib.TestFeedback{}

  @impl ROS.Message.Behaviour
  def md5sum, do: "6d3d0bf7fb3dda24779c010a9f3eb7cb"
